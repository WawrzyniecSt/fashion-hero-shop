...
export const Route = createFileRoute("/upgrade")({
  head: () => ({
    meta: [
      { title: "Premium Analytics — FashionHero dla Sellerów" },
      {
        name: "description",
        content:
          "Heatmapy, nagrania sesji, predykcja zwrotów. Wybierz plan analityczny dopasowany do Twojego sklepu.",
      },
      { property: "og:title", content: "Premium Analytics — FashionHero" },
      { property: "og:description", content: "Zobacz co robią klienci na Twojej stronie." },
    ],
  }),
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-cream">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center md:py-28">
          ...
          <div className="border border-border bg-background shadow-sm">
            <img
              src={dashboardImg}
              alt="Podgląd panelu analitycznego FashionHero"
              width={1600}
              height={1024}
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:py-28">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <div
              key={feature.title}
              className="border border-border bg-card p-8 transition hover:border-primary/40 hover:shadow-sm"
            >
          ...
          <Carousel opts={{ align: "start" }} className="w-full">
            <CarouselContent className="-ml-4">
              {LESSONS.map((lesson) => (
                ...
                >
                  <div className="group flex h-full flex-col border border-border bg-card transition hover:border-primary/40 hover:shadow-sm">
        ...
        <div className="mx-auto max-w-7xl px-6 py-20 md:py-[40px] pb-0">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              ...
              <div
                key={item.label}
                className="border border-border bg-background p-8 text-center transition hover:border-primary/40 hover:shadow-sm"
              >
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 md:py-28 pt-0 pb-0">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            <div
              key={t.name}
              className="flex flex-col border border-border bg-card p-8 transition hover:border-primary/40 hover:shadow-sm"
            >
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-10 text-xs text-muted-foreground md:flex-row">
          <span>© FashionHero Analytics</span>
          <Link to="/" className="hover:text-foreground">Wróć do panelu</Link>
        </div>
      </footer>
    </div>
  );
