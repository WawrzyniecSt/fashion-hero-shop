...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Twój panel sprzedawcy w FashionHero." },
    ],
  }),
...
function SellerPanel() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Promo banner — entry point to landing */}
      <Link
        to="/upgrade"
      ...
      <div className="mt-6 flex flex-col items-center justify-between gap-4 border-t border-border pt-4 sm:flex-row">
        ...
        <div className="flex items-center gap-2 text-sm">
          <button
            ...
            disabled={page === 1}
            className="border border-border bg-card px-3 py-1 disabled:opacity-40"
          >
            Poprzednia
          </button>
